...
I used SQL to filter data and extract key insights from the World Bank database. For more details, you can check out the complete code and dataset on my [GitHub repository](https://github.com/StojkovicS/reserves_to_debt).
